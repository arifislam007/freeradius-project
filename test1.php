...
<html>
<head>
    <title>View Data with Group Name</title>
</head>
<body>
    <h1>View Data with Group Name</h1>
    ...
    $query = "SELECT rc.username, rc.value, rug.groupname
              FROM radcheck rc
    ...
    if ($result->num_rows > 0) {
        echo "<table border='1'>";
        echo "<tr><th>Username</th><th>Value</th><th>Group Name</th></tr>";
